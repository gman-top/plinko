...
export const BALL_TYPES = {
  ...
  fire:    { id:'fire',    name:'FIRE',       tint:'#FF3300', core:'#FFB347', deep:'#8B2500', glow:'#FF6B1A', payoutMul:1.5, cinematic:true,  weight:8 },
  electric:{ id:'electric',name:'ELECTRIC',   tint:'#2AB8FF', core:'#9BC8FF', deep:'#0A3E5C', glow:'#2090FF', payoutMul:1.2, cinematic:true,  weight:6 },
  wild:    { id:'wild',    name:'WILD',       tint:'#E040A0', core:'#FFE695', deep:'#5C0A40', glow:'#B946FF', payoutMul:2,   cinematic:true,  weight:4 },
  jackpot: { id:'jackpot', name:'JACKPOT',    tint:'#FF1133', core:'#FFE695', deep:'#7A0F0F', glow:'#FF2D2D', payoutMul:5,   cinematic:true,  weight:0.5 },
};
...
export const MULT_TABLE = {
  ...
  HIGH: {
    ...
    12: [128, 24, 5, 2, 0.7, 0.3, 0.2, 0.3, 0.7, 2, 5, 24, 128],
    14: [256, 43, 7, 3, 1, 0.5, 0.2, 0.2, 0.2, 0.5, 1, 3, 7, 43, 256],
    16: [1000, 130, 26, 9, 4, 1.4, 0.5, 0.3, 0.2, 0.3, 0.5, 1.4, 4, 9, 26, 130, 1000],
  },
};
